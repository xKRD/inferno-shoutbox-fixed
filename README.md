...
#### Description
The shoutbox `newshout` action completely lacks CSRF token validation, allowing attackers to forge requests that post messages on behalf of authenticated users without their knowledge or consent.
